...
Olvi-Vec in Platinum-Resistant/Refractory Ovarian Cancer: Genelux continues to advance Olvi-Vec toward potential registration in platinum-resistant/refractory ovarian cancer (PRROC). Intraperitoneal administration of Olvi-Vec enables high and condensed dosing in PRROC, where patients need options that can deliver anti-tumor activity and effectively reverse platinum resistance:
